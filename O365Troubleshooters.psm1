...
<html>
	<head>
        ...
        <title>$PageTitle</Title>
        <link rel="titlebar icon" href="data:image/png;base64," />
	...
	<body class="ms-Fabric" dir="ltr">
		...
		<div class="label1"">
			...
			<div style="width: 100%; height: 100%; " >
				<h5 class="ms-font-su ms-fontColor-themePrimary">
					$ReportTitle
				</h5>
			</div>
		</div>
    ...
    foreach ($Entry in $TheObjectToConvertToHTML) {
        $TheBody = $TheBody + "
        	`<section class=`"accordion`"`>
				...
				`<h2 class=`"handle`"`>
					`<label for=`"handle$i`" `>
						`<h2 class=`"ms-font-su ms-fontColor-themePrimary`" style=`"display: inline-block; margin-left: -30px; color: $($Entry.SectionTitleColor); font-size: 20px; font-weight: 500;`"`>&nbsp;&nbsp;&nbsp;&nbsp;$($Entry.SectionTitle)`</h2`>
					`</label`>
				`</h2`>
				`<div class=`"content`"`>
        ...
        if ($Entry.DataType -eq "String") {
            $TheValue = "					`<p`>$($Entry.EffectiveData)`<`/p>"
        }
        else {
            $TheProperties = ($($Entry.EffectiveData)| Get-Member -MemberType NoteProperty).Name
            ...
            if ($Entry.TableType -eq "List") {
                ...
                foreach ($NewEntryFound in $TheValue) {
                    if ($NewEntryFound -like "*<tr><td>*"){
                        $TheValue.Item($z) = $NewEntryFound.Replace("<tr><td>", "<tr><th style=`"text-align: left;`">")
