    ...
    foreach ($Entry in $TheObjectToConvertToHTML) {
        $TheBody = $TheBody + "
        	`<section class=`"accordion`"`>
				...
				`<h2 class=`"handle`"`>
					`<label for=`"handle$i`" `>
						`<h2 class=`"ms-font-su ms-fontColor-themePrimary`" style=`"display: inline-block; margin-left: -30px; color: $($Entry.SectionTitleColor); font-size: 20px; font-weight: 650;`"`>&nbsp;&nbsp;&nbsp;&nbsp;$($Entry.SectionTitle)`</h2`>
					`</label`>
				`</h2`>
				`<div class=`"content`"`>
